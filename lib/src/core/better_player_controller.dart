...
class BetterPlayerController {
  ...
  final StreamController<bool> _qualityVisibilityStreamController = StreamController.broadcast();

  final StreamController<bool> _speedVisibilityStreamController = StreamController.broadcast();
  ...
  Stream<bool> get qualityVisibilityStream => _qualityVisibilityStreamController.stream;

  Stream<bool> get speedVisibilityStream => _speedVisibilityStreamController.stream;
    ...
    if (isPipSupported) {
      ...
      if (Platform.isIOS) {
        final RenderBox? renderBox =
            (betterPlayerGlobalKey.currentContext ?? context)?.findRenderObject() as RenderBox?;
        if (renderBox == null) {
