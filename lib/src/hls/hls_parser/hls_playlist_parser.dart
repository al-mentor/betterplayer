...
class HlsPlaylistParser {
  ...
  Future<HlsPlaylist> parse(Uri? uri, List<String> inputLineList) async {
    ...
    if (inputLineList.isEmpty) {
      throw UnrecognizedInputFormatException('No input line list', uri);
    }
  ...
  HlsMasterPlaylist _parseMasterPlaylist(Iterator<String> extraLines, String baseUri) {
    ...
    while (extraLines.moveNext()) {
      ...
      if (line.startsWith(tagDefine)) {
        final String? key =
            _parseStringAttr(source: line, pattern: regexpName, variableDefinitions: variableDefinitions);
        final String? val =
            _parseStringAttr(source: line, pattern: regexpValue, variableDefinitions: variableDefinitions);
        if (key == null) {
        ...
        final SchemeData? schemeData =
            _parseDrmSchemeData(line: line, keyFormat: keyFormat, variableDefinitions: variableDefinitions);

        if (schemeData != null) {
          final String? method =
              _parseStringAttr(source: line, pattern: regexpMethod, variableDefinitions: variableDefinitions);
          final String scheme = _parseEncryptionScheme(method);
          final DrmInitData drmInitData =
              DrmInitData(schemeType: scheme, schemeData: [schemeData]); // ignore: always_specify_types
        ...
        final String? averageBandwidthString =
            _parseStringAttr(source: line, pattern: regexpAverageBandwidth, variableDefinitions: variableDefinitions);
        if (averageBandwidthString != null) {
          averageBitrate = int.parse(averageBandwidthString);
        }
        final String? codecs =
            _parseStringAttr(source: line, pattern: regexpCodecs, variableDefinitions: variableDefinitions);
        final String? resolutionString =
            _parseStringAttr(source: line, pattern: regexpResolutions, variableDefinitions: variableDefinitions);
        int? width;
        int? height;
        ...
        final String? frameRateString =
            _parseStringAttr(source: line, pattern: regexpFrameRate, variableDefinitions: variableDefinitions);
        if (frameRateString != null) {
          frameRate = double.parse(frameRateString);
        }
        final String? videoGroupId =
            _parseStringAttr(source: line, pattern: regexpVideo, variableDefinitions: variableDefinitions);
        final String? audioGroupId =
            _parseStringAttr(source: line, pattern: regexpAudio, variableDefinitions: variableDefinitions);
        final String? subtitlesGroupId =
            _parseStringAttr(source: line, pattern: regexpSubtitles, variableDefinitions: variableDefinitions);
        final String? closedCaptionsGroupId =
            _parseStringAttr(source: line, pattern: regexpClosedCaptions, variableDefinitions: variableDefinitions);

        extraLines.moveNext();

        final String referenceUri =
            _parseStringAttr(source: extraLines.current, variableDefinitions: variableDefinitions)!;
    ...
    for (var line in mediaTags) {
      final String? groupId =
          _parseStringAttr(source: line, pattern: regexpGroupId, variableDefinitions: variableDefinitions);
      final String? name =
          _parseStringAttr(source: line, pattern: regexpName, variableDefinitions: variableDefinitions);
      final String? referenceUri =
          _parseStringAttr(source: line, pattern: regexpUri, variableDefinitions: variableDefinitions);

      Uri uri = Uri.parse(baseUri);
      if (referenceUri != null) uri = uri.resolve(referenceUri);

      final String? language =
          _parseStringAttr(source: line, pattern: regexpLanguage, variableDefinitions: variableDefinitions);
      ...
      Format format;
      final HlsTrackMetadataEntry entry =
          HlsTrackMetadataEntry(groupId: groupId, name: name, variantInfos: <VariantInfo>[]);
        ...
        case typeAudio:
          {
            ...
            final String? codecs =
                variant != null ? LibUtil.getCodecsOfType(variant.format.codecs, Util.trackTypeAudio) : null;
        ...
        case typeClosedCaptions:
          {
            final String instreamId =
                _parseStringAttr(source: line, pattern: regexpInStreamId, variableDefinitions: variableDefinitions)!;
            String mimeType;
  ...
  static String? _parseStringAttr({
    ...
    return value?.replaceAllMapped(RegExp(regexpVariableReference),
...
//      Uint8List psshData; //todo 保留
  ...
  static int _parseRoleFlags(String line, Map<String?, String> variableDefinitions) {
    final String? concatenatedCharacteristics =
        _parseStringAttr(source: line, pattern: regexpCharacteristics, variableDefinitions: variableDefinitions);
  ...
  static int? _parseChannelsAttribute(String line, Map<String?, String> variableDefinitions) {
    final String? channelsString =
        _parseStringAttr(source: line, pattern: regexpChannels, variableDefinitions: variableDefinitions);
  ...
  static HlsMediaPlaylist _parseMediaPlaylist(
      HlsMasterPlaylist masterPlaylist, List<String> extraLines, String baseUri) {
    ...
    for (final line in extraLines) {
      ...
      if (line.startsWith(tagPlaylistType)) {
        final String? playlistTypeString =
            _parseStringAttr(source: line, pattern: regexpPlaylistType, variableDefinitions: variableDefinitions);
        ...
        final String string = _parseStringAttr(
            source: line, pattern: regexpTimeOffset, variableDefinitions: {})!; // ignore: always_specify_types
        startOffsetUs = (double.parse(string) * 1000000).toInt();
      } else if (line.startsWith(tagInitSegment)) {
        final String? uri =
            _parseStringAttr(source: line, pattern: regexpUri, variableDefinitions: variableDefinitions);
        final String? byteRange =
            _parseStringAttr(source: line, pattern: regexpAttrByteRange, variableDefinitions: variableDefinitions);
        if (byteRange != null) {
        ...
        final String? importName =
            _parseStringAttr(source: line, pattern: regexpImport, variableDefinitions: variableDefinitions);
        if (importName != null) {
        ...
        segmentTitle = _parseStringAttr(
            source: line, pattern: regexpMediaTitle, defaultValue: '', variableDefinitions: variableDefinitions);
        ...
        if (methodNone == method) {
          ...
          fullSegmentEncryptionIV =
              _parseStringAttr(source: line, pattern: regexpIv, variableDefinitions: variableDefinitions);
        ...
        final String byteRange =
            _parseStringAttr(source: line, pattern: regexpByteRange, variableDefinitions: variableDefinitions)!;
        final List<String> splitByteRange = byteRange.split('@');
        segmentByteRangeLength = int.parse(splitByteRange[0]);
        if (splitByteRange.length > 1) {
          segmentByteRangeOffset = int.parse(splitByteRange[1]);
